...
import { N8nButton, N8nOption, N8nSelect, N8nSpinner, N8nText } from '@n8n/design-system';
			...
			<div :class="$style.content">
				<div :class="$style.field">
					<N8nText size="small" color="text-base">
						{{ locale.baseText('evaluations.addToDataset.config.label') }}
					</N8nText>
					<N8nSelect
					...
					<N8nText v-else size="medium" color="text-dark" :bold="true">
						{{ selectedConfigName }}
					</N8nText>
				</div>
				...
				<div v-else :class="$style.mapping" data-test-id="add-execution-to-dataset-mapping">
					<N8nText size="small" color="text-base">
						{{ locale.baseText('evaluations.addToDataset.mapping.title') }}
					</N8nText>
					<div
					...
					>
						<div :class="$style.column">
							<N8nText size="small" color="text-dark" :bold="true">{{ column.name }}</N8nText>
